 ...
 */
/**
 * changelog ========= 25/12/2019 (gmoralis) -Added support for TextFieldProperty.Type.INT load/save
 */
...
public class DetailCrud<T> {
      ...
      if (anotextArea instanceof TextAreaProperty) {
        ...
        try {
          ...
          if (propName.equals("text")) {
            final Property<String> controller = getProperty(propName, findObject);
            controller.setValue(
                getStringNonPropertyModel(f.getName().replace("textArea", ""), modelObject));
          }
        } catch (IllegalArgumentException | IllegalAccessException ex) {
          ex.printStackTrace();
        }
    ...
    for (Field f : declaredFields) {
      ...
      if (ano instanceof TextFieldProperty) {
        ...
        try {
          ...
          if (type.toString().equals("int") && propName.equals("text")) {
            final Property<String> controller = getProperty(propName, findObject);
            setIntegerNonPropertyModel(
                f.getName(), modelObject, Integer.valueOf(controller.getValue()));
          }
        } catch (IllegalArgumentException | IllegalAccessException ex) {
          ex.printStackTrace();
        }
      ...
      if (anotextArea instanceof TextAreaProperty) {
        ...
        try {
          ...
          if (propName.equals("text")) {
            final Property<String> controller = getProperty(propName, findObject);
            setStringNonPropertyModel(
                f.getName().replace("textArea", ""), modelObject, controller.getValue());
          }
        } catch (IllegalArgumentException | IllegalAccessException ex) {
          ex.printStackTrace();
        }
  ...
  private <T extends String> T getStringNonPropertyModel(String propertyName, Object fromThis) {
    try {
      Method propertyGetter =
          fromThis.getClass().getMethod("get" + propertyName.replace("text", ""));
  ...
  private <T extends Boolean> T getBooleanNonPropertyModel(String propertyName, Object fromThis) {
    try {
      Method propertyGetter =
          fromThis.getClass().getMethod("get" + propertyName.replace("checkBox", ""));
      return (T) propertyGetter.invoke(fromThis);
    } catch (NoSuchMethodException
        | SecurityException
        | IllegalAccessException
  ...
  private void setStringNonPropertyModel(String propertyName, Object fromThis, String param) {
    try {
      Method propertyGetter =
          fromThis.getClass().getMethod("set" + propertyName.replace("text", ""), String.class);
  ...
  private void setIntegerNonPropertyModel(String propertyName, Object fromThis, Integer param) {
    try {
      Method propertyGetter =
          fromThis.getClass().getMethod("set" + propertyName.replace("text", ""), Integer.class);
      propertyGetter.invoke(fromThis, param);
    } catch (NoSuchMethodException
        | SecurityException
        | IllegalAccessException
  ...
  private void setBooleanPropertyModel(String propertyName, Object fromThis, Boolean param) {
    try {
      Method propertyGetter =
          fromThis
              .getClass()
              .getMethod("set" + propertyName.replace("checkBox", ""), Boolean.class);
      propertyGetter.invoke(fromThis, param);
    } catch (NoSuchMethodException
        | SecurityException
        | IllegalAccessException
