...
public class LeftSideMenuView implements Initializable {
  ...
  @FXML private TitledPane partners_title;
  @FXML private TitledPane invoices_title;
  @FXML private TitledPane cash_title;
  @FXML private TitledPane items_title;
  @FXML private TitledPane reports_title;
  @FXML private TitledPane util_title;
  ...
  private void partnersAction(ActionEvent event) {
    FxmlUtil.LoadResult<TraderListView> Transactor =
        FxmlUtil.load("/fxml/trader/TraderListView.fxml");
